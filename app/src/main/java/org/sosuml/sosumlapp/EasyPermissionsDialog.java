...
/**
 * Note that this class is basically EasyPermissions, except that I allowed
 * the class to use a customized dialog with my own theme. I was not able
 * to figure out how to generalize AlertDialog elements in the app and
 * they were showing up as all white, so the messy solution was to take
 * the original EasyPermissions class and change the functions in a way to
 * use my theme.
 *
 * @author Roy Van Liew
 */
public class EasyPermissionsDialog {

    private static final String TAG = "EasyPermissionsDialog";
    ...
    public static void requestPermissions(final Object object, String rationale,
        ...
        final EasyPermissionsDialog.PermissionCallbacks callbacks = (EasyPermissionsDialog.PermissionCallbacks) object;
        ...
        if (shouldShowRationale) {
            AlertDialog dialog = new AlertDialog.Builder(getActivity(object), R.style.SOSAlertDialog)
     ...
     * callbacks through {@link EasyPermissionsDialog.PermissionCallbacks} and methods annotated with
     ...
     *                                  {@link EasyPermissionsDialog.PermissionCallbacks}.
     */
    public static void onRequestPermissionsResult(int requestCode, String[] permissions,
                                                  int[] grantResults, Object object) {

        checkCallingObjectSuitability(object);
        EasyPermissionsDialog.PermissionCallbacks callbacks = (EasyPermissionsDialog.PermissionCallbacks) object;
    ...
    private static void checkCallingObjectSuitability(Object object) {
        ...
        if (!(object instanceof EasyPermissionsDialog.PermissionCallbacks)) {
